<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:img  Version:1.9.3.0 - Wed Jun 11 17:02:15 UTC 2025 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="img:Data_Quality">
      <sch:assert test="if (img:above_aft_flag) then img:above_aft_flag = ('true', 'false') else true()">
        <title>img:Data_Quality/img:above_aft_flag</title>
        The attribute img:above_aft_flag must be equal to one of the following values 'true', 'false'.</sch:assert>
      <sch:assert test="if (img:below_aft_flag) then img:below_aft_flag = ('true', 'false') else true()">
        <title>img:Data_Quality/img:below_aft_flag</title>
        The attribute img:below_aft_flag must be equal to one of the following values 'true', 'false'.</sch:assert>
      <sch:assert test="if (img:full_well_limit_flag) then img:full_well_limit_flag = ('true', 'false') else true()">
        <title>img:Data_Quality/img:full_well_limit_flag</title>
        The attribute img:full_well_limit_flag must be equal to one of the following values 'true', 'false'.</sch:assert>
      <sch:assert test="if (img:image_corrupt_flag) then img:image_corrupt_flag = ('true', 'false') else true()">
        <title>img:Data_Quality/img:image_corrupt_flag</title>
        The attribute img:image_corrupt_flag must be equal to one of the following values 'true', 'false'.</sch:assert>
      <sch:assert test="if (img:metadata_corrupt_flag) then img:metadata_corrupt_flag = ('true', 'false') else true()">
        <title>img:Data_Quality/img:metadata_corrupt_flag</title>
        The attribute img:metadata_corrupt_flag must be equal to one of the following values 'true', 'false'.</sch:assert>
      <sch:assert test="if (img:missing_temperature_flag) then img:missing_temperature_flag = ('true', 'false') else true()">
        <title>img:Data_Quality/img:missing_temperature_flag</title>
        The attribute img:missing_temperature_flag must be equal to one of the following values 'true', 'false'.</sch:assert>
      <sch:assert test="if (img:out_of_focus_flag) then img:out_of_focus_flag = ('true', 'false') else true()">
        <title>img:Data_Quality/img:out_of_focus_flag</title>
        The attribute img:out_of_focus_flag must be equal to one of the following values 'true', 'false'.</sch:assert>
      <sch:assert test="if (img:saturated_flag) then img:saturated_flag = ('true', 'false') else true()">
        <title>img:Data_Quality/img:saturated_flag</title>
        The attribute img:saturated_flag must be equal to one of the following values 'true', 'false'.</sch:assert>
      <sch:assert test="if (img:sequence_terminated_flag) then img:sequence_terminated_flag = ('true', 'false') else true()">
        <title>img:Data_Quality/img:sequence_terminated_flag</title>
        The attribute img:sequence_terminated_flag must be equal to one of the following values 'true', 'false'.</sch:assert>
      <sch:assert test="if (img:wrong_filter_flag) then img:wrong_filter_flag = ('true', 'false') else true()">
        <title>img:Data_Quality/img:wrong_filter_flag</title>
        The attribute img:wrong_filter_flag must be equal to one of the following values 'true', 'false'.</sch:assert>
      <sch:assert test="if (img:wrong_pointing_flag) then img:wrong_pointing_flag = ('true', 'false') else true()">
        <title>img:Data_Quality/img:wrong_pointing_flag</title>
        The attribute img:wrong_pointing_flag must be equal to one of the following values 'true', 'false'.</sch:assert>
      <sch:assert test="if (img:wrong_zoom_flag) then img:wrong_zoom_flag = ('true', 'false') else true()">
        <title>img:Data_Quality/img:wrong_zoom_flag</title>
        The attribute img:wrong_zoom_flag must be equal to one of the following values 'true', 'false'.</sch:assert>
      <sch:assert test="if (img:zero_value_pixels_flag) then img:zero_value_pixels_flag = ('true', 'false') else true()">
        <title>img:Data_Quality/img:zero_value_pixels_flag</title>
        The attribute img:zero_value_pixels_flag must be equal to one of the following values 'true', 'false'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="img:Detector">
  ...
  <sch:pattern>
    <sch:rule context="img:Onboard_Compression/img:onboard_compression_type">
      <sch:assert test=". = ('GZIP', 'H.264 Frame', 'ICER', 'ICT', 'JPEG', 'JPEG Progressive', 'LOCO', 'LZO', 'Lossless', 'MSSS Lossless', 'None', 'StarPixel Flexible', 'StarPixel Lossless', 'Wavelet')">
        <title>img:Onboard_Compression/img:onboard_compression_type/img:onboard_compression_type</title>
        The attribute img:Onboard_Compression/img:onboard_compression_type must be equal to one of the following values 'GZIP', 'H.264 Frame', 'ICER', 'ICT', 'JPEG', 'JPEG Progressive', 'LOCO', 'LZO', 'Lossless', 'MSSS Lossless', 'None', 'StarPixel Flexible', 'StarPixel Lossless', 'Wavelet'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
